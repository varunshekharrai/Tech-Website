	...
	<body>
		...
		<section class="blog">
			<div class="container row">
					...
					while($row = mysqli_fetch_assoc($rs)){
						...
						$res = mysqli_query($con,$user);
							while($rowuid = mysqli_fetch_assoc($res)){
								echo "<a href='oneblog.php?bid=".$row["bid"]."' style='color: black;'><div class='col s12'>
				...
				?>
				<a class="col l2 push-l10 s12 waves-effect waves-light btn" href="newblog.php">Create a new Blog</a>
			</div>
		</section>
